...
PORT = 1883
TOPICS = ["test", "alerts"]  # Include both test and alerts topics
...
def on_message(client, userdata, msg):
    ...
    # Check for critical conditions and send alerts if topic is 'test'
    if topic == "test" and "Weight:" in message:
        try:
